...
- (void)addButtonsToView:(UIView*)container {
    ...
    // Bottom View holds button
    UIView *bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, container.bounds.size.height - kDatePickerDialogDefaultButtonHeight, container.bounds.size.width, kDatePickerDialogDefaultButtonHeight)];
    bottomView.backgroundColor = [UIColor colorWithRed:66.0/255.0 green:152.0/255.0 blue:153.0/255.0 alpha:1.0];
...
//        [cancelButton setTitleColor:[cancelButton tintColor] forState:UIControlStateHighlighted];
        ...
        [container bringSubviewToFront:cancelButton];
...
//    [doneButton setTitleColor:[doneButton tintColor] forState:UIControlStateHighlighted];
    ...
    [container bringSubviewToFront:doneButton];
